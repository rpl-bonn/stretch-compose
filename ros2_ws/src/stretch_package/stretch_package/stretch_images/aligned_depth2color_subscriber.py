...
class AlignedDepth2ColorSubscriber(Node):
    ...
    def save_image(self):
        if self.rotate:
            image_path = '/home/ws/data/images/head_image_aligned.png'
        else:
            image_path = '/home/ws/data/images/gripper_image_aligned.png'
...
def main(args=None):
    ...
    node = AlignedDepth2ColorSubscriber('/camera/aligned_depth_to_color/image_raw', rotate=True, save=True, vis=True)
    # node = AlignedDepth2ColorSubscriber('/gripper_camera/aligned_depth_to_color/image_raw', rotate=False, save=True, vis=True)
    node.destroy_node()
    rclpy.shutdown()
