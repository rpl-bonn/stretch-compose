...
def save_files(data: list[(str, Callable[[str, Any], Any], Any)], save_path: str) -> list[str]:
    """
...
def send_request(server_address: str, paths_dict: dict[str, str], params: dict, timeout: int, save_path: str) -> dict[str, Any]:
    """
