...
from urdf_utils import kdl_tree_from_urdf_model
...
class HelloRobot:
    def __init__(
        ...
        self.init_joint_list = ["joint_fake", "joint_lift", "3", "2", "1", "0", "joint_wrist_yaw", "joint_wrist_pitch",
                                "joint_wrist_roll", "joint_gripper_finger_left"]

        # end_link is the frame of reference node
        self.end_link = end_link
        if end_link == GRIPPER_FINGERTIP_LEFT_NODE or GRIPPER_FINGERTIP_RIGHT_NODE:
        ...
        # Loading URDF and listing the intermediate joints from base to gripper
    ...
    def move_to_position(
        ...
        if gripper_pos is not None:
            CURRENT_STATE = gripper_pos * (self.STRETCH_GRIPPER_MAX - self.STRETCH_GRIPPER_MIN) + self.STRETCH_GRIPPER_MIN
            self.robot.manip.move_gripper(CURRENT_STATE)
    ...
    def update_joints(self):
        ...
        arm_pos = state[2]
        self.joints['3'] = arm_pos / 4.0
        self.joints['2'] = arm_pos / 4.0
        self.joints['1'] = arm_pos / 4.0
        self.joints['0'] = arm_pos / 4.0
    ...
    def move_to_joints(self, joints, mode=0):
        """
    ...
    def get_joint_transform(self, node1, node2):
        ...
        # Initializing chain -> maintains list of nodes from base link to corresponding nodes
        chain1 = self.kdl_tree.getChain('base_link', node1)
        chain2 = self.kdl_tree.getChain('base_link', node2)

        # Initializing corresponding joint array and forward chain solvers
        ...
        # Initializing frames corresponding to nodes
        frame1 = PyKDL.Frame()
        frame2 = PyKDL.Frame()
    ...
    def move_to_pose(self, translation_tensor, rotational_tensor, move_mode=0):
        """
        ...
        self.move_to_joints(ik_joints, move_mode)
