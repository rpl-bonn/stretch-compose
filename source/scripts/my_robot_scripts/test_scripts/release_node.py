...
def release_door():
    ...
    sleep_time=1
    pos_1 = {'wrist_extension': (0.414,60.0)}
    pos_2 = {'joint_wrist_yaw': 0.633}
    pos_3 = {'wrist_extension': (0.3076,60.0)}
    pos_4 = {'joint_wrist_yaw': 0.35}
    pos_5 = {'wrist_extension': (0.066,60.0)}
    pos_6 = {'joint_gripper_finger_left': 0.2}
    pos_7 = {'joint_wrist_pitch': -0.896}
